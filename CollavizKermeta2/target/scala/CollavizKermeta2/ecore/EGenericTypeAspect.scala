...
trait EGenericTypeAspect extends k2.standard.KermetaObjectAspect with `_root_`.org.eclipse.emf.ecore.EGenericType{
  ...
  def ScalaeUpperBound_=(`~value` : _root_.org.eclipse.emf.ecore.EGenericType):Unit={
	this.setEUpperBound(`~value`)  }
  def ScalaeTypeArguments : k2.standard.ReflectiveOrderedSet[CollavizKermeta2.ecore.EGenericTypeAspect,_root_.org.eclipse.emf.ecore.EGenericType]={    new k2.standard.RichReflectiveOrderedSet[CollavizKermeta2.ecore.EGenericTypeAspect,_root_.org.eclipse.emf.ecore.EGenericType](thisUpper = -1,value=this.getETypeArguments())}
  def ScalaeTypeArguments_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.eclipse.emf.ecore.EGenericType]):Unit={
  ...
  def ScalaeLowerBound_=(`~value` : _root_.org.eclipse.emf.ecore.EGenericType):Unit={
	this.setELowerBound(`~value`)  }
  ...
  def ScalaeTypeParameter_=(`~value` : _root_.org.eclipse.emf.ecore.ETypeParameter):Unit={
	this.setETypeParameter(`~value`)  }
  ...
  def ScalaeClassifier_=(`~value` : _root_.org.eclipse.emf.ecore.EClassifier):Unit={
	this.setEClassifier(`~value`)  }
