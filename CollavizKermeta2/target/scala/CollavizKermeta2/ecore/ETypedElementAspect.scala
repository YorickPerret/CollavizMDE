...
trait ETypedElementAspect extends CollavizKermeta2.ecore.ENamedElementAspect with `_root_`.org.eclipse.emf.ecore.ETypedElement{
  def Scalaordered : _root_.java.lang.Boolean={this.isOrdered().asInstanceOf[_root_.java.lang.Boolean]}
  def Scalaordered_=(`~value` : _root_.java.lang.Boolean):Unit={
	this.setOrdered(`~value`)  }
  def Scalaunique : _root_.java.lang.Boolean={this.isUnique().asInstanceOf[_root_.java.lang.Boolean]}
  def Scalaunique_=(`~value` : _root_.java.lang.Boolean):Unit={
  ...
  def ScalalowerBound_=(`~value` : _root_.java.lang.Integer):Unit={
  ...
  def ScalaupperBound_=(`~value` : _root_.java.lang.Integer):Unit={
  ...
  def ScalaeType_=(`~value` : _root_.org.eclipse.emf.ecore.EClassifier):Unit={
	this.setEType(`~value`)  }
  ...
  def ScalaeGenericType_=(`~value` : _root_.org.eclipse.emf.ecore.EGenericType):Unit={
	this.setEGenericType(`~value`)  }
