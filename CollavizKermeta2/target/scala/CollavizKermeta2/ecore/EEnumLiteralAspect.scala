...
trait EEnumLiteralAspect extends CollavizKermeta2.ecore.ENamedElementAspect with `_root_`.org.eclipse.emf.ecore.EEnumLiteral{
  ...
  def Scalainstance_=(`~value` : org.eclipse.emf.common.util.Enumerator):Unit={
	this.setInstance(`~value`)  }
  def Scalaliteral : _root_.java.lang.String={this.getLiteral().asInstanceOf[_root_.java.lang.String]}
  def Scalaliteral_=(`~value` : _root_.java.lang.String):Unit={
